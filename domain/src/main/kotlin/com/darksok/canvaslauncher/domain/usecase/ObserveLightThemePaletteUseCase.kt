...
class ObserveLightThemePaletteUseCase @Inject constructor(
    private val themePreferencesRepository: ThemePreferencesRepository,
) {
    operator fun invoke(): Flow<LightThemePalette> = themePreferencesRepository.observeLightThemePalette()
}
